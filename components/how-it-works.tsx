...
export function HowItWorks() {
  const steps = [
    {
      icon: <MousePointer2 className="h-12 w-12 text-emerald-600" />,
      title: "Choose Template",
      description: "Select from our range of professional badge or certificate templates.",
    },
    {
  ...
  return (
    <div className="py-16 container mx-auto px-4">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold mb-4 text-emerald-800 dark:text-emerald-400">How It Works</h2>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Creating professional credentials and certificates is quick and easy with our simple 4-step process.
        </p>
      </div>
