    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-center text-emerald-800 dark:text-emerald-400">Privacy Policy</h1>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto prose dark:prose-invert">
        ...
        <p>
          Welcome to Credential Creator Pro ("we," "our," or "us"). We respect your privacy and are committed to
        ...
        <p>
          We collect information that you voluntarily provide to us when you use our badge and certificate generation
          services:
        </p>
        <ul>
          <li>Personal information such as names, email addresses, and phone numbers</li>
          <li>Images uploaded for badges and certificates (photos, logos, signatures)</li>
        ...
        <ul>
          ...
          <li>To generate the badges and certificates you request</li>
          <li>To enable the verification of certificates and badges</li>
