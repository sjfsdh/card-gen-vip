    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-center text-emerald-800 dark:text-emerald-400">Terms of Service</h1>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto prose dark:prose-invert">
        ...
        <p>
          By accessing or using the Credential Creator Pro website and services, you agree to be bound by these Terms of
          Service. If you do not agree to these terms, please do not use our services.
        </p>

        <h2>2. Description of Service</h2>
        <p>
          Credential Creator Pro provides an online platform for creating, customizing, and downloading badges and
        ...
        <ul>
          <li>Provide accurate information when creating badges and certificates</li>
          <li>Not use our services for fraudulent purposes or to impersonate others</li>
          <li>Not create badges or certificates that violate any laws or regulations</li>
        ...
        <p>
          ...
          icons, images, audio clips, digital downloads, and software, are owned by Credential Creator Pro and are
          protected by copyright, trademark, and other intellectual property laws.
        </p>
        <p>
          You retain ownership of the content you create using our services, including badges and certificates. However,
        ...
        <p>
          To the fullest extent permitted by applicable law, Credential Creator Pro shall not be liable for any
        ...
        <p>
          You agree to indemnify and hold harmless Credential Creator Pro and its officers, directors, employees, and
        ...
        <p>
          Email: support@vipup.online
          <br />
          Phone: +1 (763) 245-8901
          <br />
          Address: 456 Credential Avenue, Suite 789, Portland, OR 97205
          <br />
