      ...
      <div className="mb-8">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-center text-emerald-800 dark:text-emerald-400">
            Download Your {type === "badge" ? "Badge" : "Certificate"}
          </h1>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div className="flex flex-col items-center">
          ...
          <div className="text-center text-sm text-muted-foreground mb-4">
            <p>Your {type === "badge" ? "badge" : "certificate"} has been generated successfully.</p>
            <p>You can download it as a PNG or PDF file.</p>
          </div>

          <div className="flex flex-wrap gap-4 justify-center">
            <Button onClick={handleDownloadPNG} className="flex items-center bg-emerald-600 hover:bg-emerald-700">
        ...
        <div className="space-y-6">
          <Card>
            <CardContent className="p-6">
              <h2 className="text-xl font-semibold mb-4 text-emerald-700 dark:text-emerald-500">
                Verification Information
              </h2>
              <p className="mb-4">
                This {type === "badge" ? "badge" : "certificate"} can be verified using the following code:
              </p>

              <div className="flex items-center p-4 bg-muted rounded-md mb-4">
                <QrCode className="h-6 w-6 mr-3 text-emerald-600" />
                <code className="font-mono text-lg">{type === "badge" ? data.badgeId : data.verificationCode}</code>
              </div>

              <p className="text-sm text-muted-foreground">
                To verify this {type === "badge" ? "badge" : "certificate"}, visit our verification page and enter the
                code above.
              </p>
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-xl font-semibold mb-4 text-emerald-700 dark:text-emerald-500">
                Share Your {type === "badge" ? "Badge" : "Certificate"}
              </h2>
              <p className="mb-4">
                Share your {type === "badge" ? "badge" : "certificate"} with others using this link:
              </p>
              ...
              <Button onClick={handleShare} className="w-full bg-emerald-600 hover:bg-emerald-700">
                <Share2 className="mr-2 h-4 w-4" />
                Copy Share Link
              </Button>
            </CardContent>
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-xl font-semibold mb-4 text-emerald-700 dark:text-emerald-500">Next Steps</h2>
              <ul className="space-y-2">
                <li className="flex items-start">
                  <span className="mr-2 text-emerald-500">✓</span>
                  <span>Download your {type === "badge" ? "badge" : "certificate"} and save it for your records.</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2 text-emerald-500">✓</span>
                ...
                {type === "badge" && (
                  <li className="flex items-start">
                    <span className="mr-2 text-emerald-500">✓</span>
                    <span>Consider laminating your badge for durability.</span>
                  </li>
                )}
              </ul>
