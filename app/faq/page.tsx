    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-3xl mx-auto">
        <p className="text-muted-foreground mb-8">
          Find answers to the most common questions about our badge and certificate generator.
        </p>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              No, our service is designed to be used without registration. You can create, customize, and download
              badges and certificates without creating an account.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              You can download your badges and certificates as PNG images or PDF files. Both formats are high-resolution
          ...
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              Yes, you can upload your own logo, signature, and photos to personalize your badges and certificates. We
          ...
          <AccordionItem value="item-5">
            ...
            <AccordionContent>
              Each certificate and badge is generated with a unique verification code. Anyone can verify the
              authenticity of your document by entering this code on our verification page.
            </AccordionContent>
          </AccordionItem>

          <AccordionItem value="item-6">
            <AccordionTrigger>Can I create multiple badges or certificates at once?</AccordionTrigger>
            <AccordionContent>
              Currently, our free service allows you to create one document at a time. For bulk generation, please
              contact us at support@vipup.online for custom solutions tailored to your organization's needs.
            </AccordionContent>
          </AccordionItem>

          <AccordionItem value="item-7">
            <AccordionTrigger>What types of badges and certificates can I create?</AccordionTrigger>
            <AccordionContent>
              You can create various types of badges (corporate, event, visitor, conference, staff) and certificates
              (completion, achievement, appreciation, participation, excellence, graduation).
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-10">
            ...
            <AccordionContent>
              ...
              or email us at support@vipup.online. You can also call us at +1 (763) 245-8901 during business hours.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
